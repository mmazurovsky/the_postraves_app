...
extension EventStatusExtension on EventStatus {
  ...
  static _getEventStatusNameMapping(BuildContext context, EventStatus status) => {
    EventStatus.UPCOMING: AppLocalizations.of(context)!.wikiEventStatusUpcoming,
    EventStatus.PRESALE: AppLocalizations.of(context)!.wikiEventStatusPresale,
    EventStatus.TOMORROW: AppLocalizations.of(context)!.wikiEventStatusTomorrow,
  ...
  String getStatusName(BuildContext context) => _getEventStatusNameMapping(context, this);
}
